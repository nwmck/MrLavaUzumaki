...
# =============================================================================
# BATCH PROCESSING / PARALLEL EXECUTION SETTINGS
# These settings are only used by run_batch.py, ignored by mr_lava_loba.py
# =============================================================================

# Worker mode for parallel processing:
# 'fixed' => use exactly n_workers processes
# 'auto'  => use (total_cpu_cores - cores_to_reserve) processes
worker_mode = 'fixed'

# Number of parallel workers (only used when worker_mode='fixed')
n_workers = 2

# Number of CPU cores to keep free (only used when worker_mode='auto')
# Recommended: at least 1-2 to keep system responsive
cores_to_reserve = 2

# Set to True to skip RAM usage checks (not recommended for large DEMs)
